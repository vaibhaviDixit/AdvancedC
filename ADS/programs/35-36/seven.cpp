...
Output: Following is Inorder traversal of the merged tree: 20 40 50 70 80 100 120 300
...
/*
This program takes two balanced BSTs as input and merges them into a single balanced BST. It does so by performing the following steps:

Traverses both trees using in-order traversal and stores their elements in two arrays.
Merges the two arrays into a single sorted array.
Constructs a new balanced BST from the merged sorted array using a helper function.
Outputs the in-order traversal of the merged BST.
